...
CREATE TABLE orders (
    id SERIAL PRIMARY KEY,
    customer_id INTEGER REFERENCES customers(id), -- ADDED FOREIGN KEY constraint
...
CREATE TABLE products (
    ...
    inventory_count INTEGER DEFAULT 0 CHECK (inventory_count >= 0), -- ADDED CHECK CONSTRAINT
...
CREATE TABLE payments (
    id SERIAL PRIMARY KEY,
    order_id INTEGER NOT NULL UNIQUE, -- ADDED UNIQUE CONSTRAINT
